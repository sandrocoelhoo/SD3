  ...
  public Node(Node other) {
    ...
    if (other.isSetCluster()) {
      ...
      for (Finger other_element : other.cluster) {
        __this__cluster.add(other_element);
      }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cluster = new java.util.ArrayList<Finger>(_list13.size);
                Finger _elem14;
                for (int _i15 = 0; _i15 < _list13.size; ++_i15)
                {
                  _elem14 = new Finger();
                  _elem14.read(iprot);
                  struct.cluster.add(_elem14);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Node struct) throws org.apache.thrift.TException {
      ...
      if (struct.cluster != null) {
        oprot.writeFieldBegin(CLUSTER_FIELD_DESC);
        {
          ...
          for (Finger _iter17 : struct.cluster)
          {
            _iter17.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetCluster()) {
        {
          ...
          for (Finger _iter19 : struct.cluster)
          {
            _iter19.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.ft = new java.util.ArrayList<Finger>(_list20.size);
          Finger _elem21;
          for (int _i22 = 0; _i22 < _list20.size; ++_i22)
          {
            _elem21 = new Finger();
            _elem21.read(iprot);
            struct.ft.add(_elem21);
          }
        }
        struct.setFtIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.cluster = new java.util.ArrayList<Finger>(_list23.size);
          Finger _elem24;
          for (int _i25 = 0; _i25 < _list23.size; ++_i25)
          {
            _elem24 = new Finger();
            _elem24.read(iprot);
            struct.cluster.add(_elem24);
          }
        }
        struct.setClusterIsSet(true);
      }
